/**
 * Netlify Function: Ryzen Pay - Verificar Status
...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        console.log('💎 [RyzenPay] Verificando status da transação:', transactionId || externalReference);
        ...
        console.error('❌ [RyzenPay] Erro ao verificar status:', error);
        return {
            statusCode: 500,
            headers,
            body: JSON.stringify({
